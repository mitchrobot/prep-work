...
def is_power_of_two?(num)
	# (0..(num/2)).each{ |x| return true if 2 ** x == num } # This is a really brute force way to find it, but it's simple and works and I don't want to Google a better way although I'm sure it exists
	# false
